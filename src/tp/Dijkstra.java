...
public class Dijkstra {
	...
	public Map<NodoGrafo, Integer> recorrer(GrafoDinamic grafo, NodoGrafo inicio) throws Exception {
		...
		// Recorremos Q mientras no sea vac�o.
		while(!Q.isEmpty()) {
	...
	/**
	 * Primero filtra D, y se queda con solo aquellos que tambi�n est�n en Q.
	 * Luego, busca el que tiene la distancia m�nima.
	 * Devuelve el NodoGrafo con distancia m�nima.
	 * @param D
